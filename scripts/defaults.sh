...
JAIL_IP_4SCREEN=$(awk -F"." '{print $1"."$2"."$3".'${JAIL_IP:-$SUGGESTED_LAST_OCTET_OF_IP}'"${COLOR_N}}'<<<${AUTO_GW_IP})
# JAIL_IP=${JAIL_IP:-$AUTO_JAIL_IP}
JAIL_IP=$(awk -F"." '{print ${COLOR_GREEN}$1"."$2"."$3".'${JAIL_IP:-$SUGGESTED_LAST_OCTET_OF_IP}'"}'<<<${AUTO_GW_IP})
